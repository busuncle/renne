...
def enter_dead_mode(screen, hero):
    ...
    while running:
        ...
        enemy_left_info = sfg.Font.MSYH_32.render(u"剩余怪物数：%s" % len(enemies), True, pygame.Color("white"))
        screen.blit(enemy_left_info, sfg.DeadMode.ENEMY_LEFT_INFO_BLIT_POS)

        # say current round
        current_round_info = sfg.Font.MSYH_32.render(u"第%s波" % current_round, True, pygame.Color("white"))
